      ...
      <div className='container mx-auto'>
        <div className='flex flex-col xl:flex-row gap-x-8 '>
          ...
          <div className='text-center flex xl:w-[300vw] flex-col lg:text-left mb-4 xl:mb-0 '>
            ...
            animate="show" 
            exit="hidden" 
            className='h2 xl:mt-8'>Hear What My Clients Have to Say<span className='text-accent'>!</span></motion.h2>
            <motion.p variants={fadeIn('up', 0.4)} 
            initial="hidden" 
            animate="show" 
            exit="hidden" className='mb-4 max-w-[400px] mx-auto lg:mx-0'> I’m grateful for amazing clients and their kind feedback. Here’s what they’ve shared.
            </motion.p>
          </div>
          {/* slider */}
